...
* **Time Zone Notice:** Displays a notification banner highlighting that all prayer times, checklist resets, and streaks are permanently anchored to Dhaka, Bangladesh (BST) time.
